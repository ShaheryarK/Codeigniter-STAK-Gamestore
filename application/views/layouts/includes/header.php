...
<html lang="en">
  ...
  <body style="background:url(<?php echo base_url(); ?>assets/images/background4.jpg); background-repeat:no-repeat;background-size:100% 100%">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo base_url(); ?>">STAK's Game Store</a>
        </div>
        ...
        <div class="row">
			 ...
			 <div class="panel panel-default">
			   <div class="panel-heading panel-heading-green">
			     <h3 class="panel-title">The Game Store</h3>
			   </div>
