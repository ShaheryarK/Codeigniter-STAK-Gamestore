...
<form method="post" action="<?php echo base_url();?>cart/thank">
    <table class="table table-striped">
					   ...
					   <th style="text-align:right">Item Price</th>
						...
						<?php foreach($this->cart->contents()as $items): ?>
							 ...
							 <td class="right" style="text-align:right"><strong>$<?php echo $this->cart->format_number($this->cart->total()+$this->config->item('total')); ?></td>
							 </tr>
				   </table>
				   <?php if(!$this->session->userdata('logged_in')) : ?>
				       <p><a href="<?php echo base_url();?>users/register" class="btn btn-primary" name="submit" value="submit"/>Create An Account</a></p>
